...
public class CarServiceImpl implements CarService {
    ...
    @Override
    public Page<Car> findLocationCarByPage(Integer locationId, Integer page, Integer size) {
        PageHelper.startPage(page,size);
        return carDao.findLocationCar(locationId);
    }

    @Override
    public Page<Car> findUserCarsByPage(Integer page, Integer size) {
        PageHelper.startPage(page,size);
        return carDao.findUserCarsByPage();
    }
}
